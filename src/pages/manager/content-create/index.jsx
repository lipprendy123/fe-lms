      ...
      >
        ...
        <div className="flex flex-col gap-[10px]">
          ...
          <div id="editor">
              ...
              name="video"
              id="video"
              className="appearance-none border rounded-2xl border-slate-300 placeholder:p-2 outline-none w-full py-3 font-semibold placeholder:font-normal placeholder:text-[#838C9D] !bg-transparent"
