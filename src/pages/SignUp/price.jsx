...
const Price = ({data}) => {
  ...
  const submitData = async () => {
    try {
      ...
      window.location.replace(response.data.midtrans_url)
      ...
      <div className="grid grid-cols-2 gap-[30px] max-w-[840px] mx-auto mt-[60px]">
        ...
        <div className="card flex flex-col h-fit rounded-[20px] border border-[#262A56] p-[30px] gap-[30px] bg-[#080A2A]">
          ...
          <div className="flex flex-col gap-5">
            <FeatureItem text="Access gigantic features company" />
            <FeatureItem text="Students analytics and export" />
          </div>
          <hr className="border-[#262A56]" />
        ...
        <div className="card flex flex-col h-fit rounded-[20px] border border-[#262A56] p-[30px] gap-[30px] bg-[#080A2A]">
          ...
          <div className="flex flex-col gap-5">
            <FeatureItem text="Access gigantic features company" />
            <FeatureItem text="Students analytics and export" />
            <FeatureItem text="Life support 24/7 maintenances" />
            <FeatureItem text="Export and analyze data real time" />
            <FeatureItem text="More big features coming soon" />
          </div>
          <hr className="border-[#262A56]" />
          <div className="flex flex-col gap-3">
...
// Komponen kecil untuk daftar fitur
